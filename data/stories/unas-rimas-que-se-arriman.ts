...
export const unasRimasQueSeArriman: Story = {
  id: 'unas-rimas-que-se-arriman',
  title: 'Unas rimas que se arriman',
  author: 'Adela Basch',
...
Al zorro le volvió enseguida el mal humor, y un rato después volvió a patear al perro que se retorció de dolor.
Más tarde el perro atacó a la liebre; la liebre, al ratón; el ratón, al cuis y el cuis a la rana.
