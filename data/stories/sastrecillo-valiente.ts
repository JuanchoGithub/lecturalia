...
export const sastrecilloValiente: Story = {
  id: 'sastrecillo-valiente',
  title: 'El sastrecillo valiente',
  author: 'Hermanos Grimm',
  coverImage: 'https://picsum.photos/seed/tailor/600/400',
  content: `
...
Dejó la rebanada de pan sobre la mesa y continuó cosiendo; y tan contento estaba, que las puntadas le salían cada vez mas largas. Mientras tanto, el dulce aroma que se desprendía de la mermelada se extendía por la habitación, hasta las paredes donde las moscas se amontonaban en gran número; éstas, sintiéndose atraídas por el olor, se lanzaron sobre el pan como un verdadero enjambre. 
...
En cuanto el gigante se echó al hombro el tronco, el sastrecillo se sentó sobre una rama, de modo que el gigante, que no podía volverse, tuvo que cargar también con él, además de todo el peso del árbol. El sastrecillo iba de lo más contento allí detrás y se puso a tararear la canción: «Tres sastres cabalgaban a la ciudad», como si el cargar árboles fuese un juego de niños. El gigante, después de llevar un buen trecho la pesada carga, no pudo más y gritó: 
...
Así que lo recibieron con todos los honores y le prepararon una residencia especial para él. Pero los soldados del rey estaban molestos con él y deseaban verlo a mil leguas de distancia. 
-¿Qué ocurrirá? -comentaban entre sí-. Si nos peleamos con él y nos ataca, a cada golpe derribará a siete. Eso no lo resistiremos. Tomaron, pues, la decisión de presentarse al rey y pedirle que los licenciase del ejército. 
-No estamos preparados -le dijeron- para estar al lado de un hombre capaz de matar a siete de un golpe. 

El rey se disgustó mucho cuando vio que por culpa de uno iba a perder a todos sus fieles servidores. Se lamentaba de haber visto al sastrecillo y, gustosamente, se habría desembarazado de él; pero no se atreía a hacerlo, por miedo a que lo matara junto a todos los suyos y luego ocupase el trono. Estuvo pensándolo largamente hasta que, por fin, encontró una solución. Mandó decir al sastrecillo que, siendo tan poderoso guerrero, tenía una propuesta que hacerle: en un bosque del reino vivían dos gigantes que causaban enormes daños con sus robos, asesinatos, incendios y otras atrocidades; nadie podía acercárseles sin correr peligro de muerte. Si él lograba vencer y exterminar a estos dos gigantes, recibiría la mano de su hija y la mitad del reino como dote nupcial; además, cien jinetes lo acompañarían y le prestarían su ayuda. 
...
Los criados, al oir estas palabras, salieron huyendo como alma que lleva el diablo y nunca jamás se les volvería a ocurrir el acercarse al sastrecillo. Y así, el joven sastre siguió siendo rey durante toda su vida.
    `,
  wordCount: 1845,
