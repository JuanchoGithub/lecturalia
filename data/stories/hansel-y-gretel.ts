...
export const hanselYGretel: Story = {
  id: 'hansel-y-gretel',
  title: 'Hansel y Gretel',
  author: 'Hermanos Grimm',
  coverImage: 'https://upload.wikimedia.org/wikipedia/commons/1/16/Offterdinger_Hansel_und_Gretel_%281%29.jpg',
  content: `
En el límite de un gran bosque vivía un pobre leñador con su mujer y sus dos hijos: el pequeño se llamaba Hansel y la pequeña Gretel. Tenía muy poco para comer y una vez que el país fue azotado por una gran hambruna no le fue posible procurarse ni el pan cotidiano.
...
Hansel y Gretel hicieron una montañita de ramas. Encendieron el haz y cuando las llamas estuvieron altas la mujer dijo -Acuéstense cerca del fuego, hijitos, y descansen; cuando terminemos los venimos a buscar.
...
-Más valdría compartir el último bocado con tus hilos.
...
Pero la vieja solamente fingía ser amable; en realidad era una bruja mala que espiaba a los niños pequeños y había construido su casita de pan solamente para atraerlos. Cuando uno caía en su poder, lo mataba, lo cocinaba, lo comía y para ella ese era un día de fiesta.
Las brujas tienen los ojos rojos y la vista de poco alcance pero, en cambio, tienen tanto olfato como los animales del bosque y su nariz siente la proximidad de los hombres. Cuando Hansel y Gretel llegaron a sus dominios, ella sonrió malignamente y dijo:
-¡No se me escaparán!
