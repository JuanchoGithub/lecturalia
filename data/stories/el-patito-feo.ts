...
Y no era que los envidiara en lo más mínimo, ¿cómo podía ocurrírsele envidiar aquella maravilla de belleza? Se habría sentido agradecido con sólo que los patos lo hubiesen tolerado entre ellos, tanta era la certeza de su fealdad.
    ...
    [QuestionCategory.LITERAL]: [
      {
        ...
        questionText: '¿Por qué la anciana de la casita decidió quedarse con el patito al principio?',
        options: ['Porque le dio pena', 'Porque quería un animal de compañía', 'Porque pensó que era un pato gordo que pondría huevos', 'Porque el gato y la gallina se lo pidieron'],
        correctAnswer: 'Porque pensó que era un pato gordo que pondría huevos',
      },
      {
        id: 'p-lit2',
        category: QuestionCategory.LITERAL,
        questionText: '¿Qué vio el patito en su propio reflejo en el agua al final de la historia?',
    ...
    [QuestionCategory.SEQUENCING]: [
      {
        ...
        questionText: '¿Qué pasó justo después de que el patito escapara del corral por primera vez?',
        options: ['Llegó a un pantano donde vivían patos silvestres', 'Encontró la casa del campesino', 'Llegó el invierno', 'Se encontró con los cisnes'],
        correctAnswer: 'Llegó a un pantano donde vivían patos silvestres',
      },
      {
        id: 'p-seq2',
        category: QuestionCategory.SEQUENCING,
    ...
    [QuestionCategory.VOCABULARY]: [
      {
        ...
        questionText: 'Cuando los gansos silvestres le hablan al patito, se dice que eran "petulantes". ¿Qué significa "petulantes"?',
        options: ['Tímidos y callados', 'Amables y generosos', 'Arrogantes y que se creen superiores', 'Tristes y cansados'],
        correctAnswer: 'Arrogantes y que se creen superiores',
      },
      {
        id: 'p-voc2',
        category: QuestionCategory.VOCABULARY,
        questionText: 'La historia dice que el patito se sentía "cohibido" al final. ¿Qué significa "cohibido"?',
    ...
    [QuestionCategory.MAIN_IDEA]: [
      {
        ...
        questionText: '¿Cuál es la lección más importante de la historia de "El Patito Feo"?',
        options: ['No hay que nadar en invierno', 'La verdadera belleza está en el interior y no debemos juzgar por las apariencias', 'Los gatos y las gallinas no son buenos amigos', 'Es importante nacer en un corral bonito'],
        correctAnswer: 'La verdadera belleza está en el interior y no debemos juzgar por las apariencias',
      },
      {
        id: 'p-main2',
        category: QuestionCategory.MAIN_IDEA,
    ...
    [QuestionCategory.INFERENCE]: [
      {
        ...
        questionText: '¿Por qué crees que el patito feo se sintió atraído por los cisnes la primera vez que los vio volar?',
        options: ['Porque eran muy ruidosos', 'Porque eran grandes y blancos, muy diferentes a él', 'Porque instintivamente se sintió conectado a ellos, ya que eran de su misma especie', 'Porque pensó que tenían comida'],
        correctAnswer: 'Porque instintivamente se sintió conectado a ellos, ya que eran de su misma especie',
      },
      {
        id: 'p-inf2',
        category: QuestionCategory.INFERENCE,
        questionText: '¿Por qué el patito decide acercarse a los cisnes al final, aunque piensa que lo van a matar?',
    ...
    [QuestionCategory.CHARACTER]: [
      {
        ...
        questionText: '¿Qué dos palabras describen mejor al patito al principio de la historia?',
        options: ['Orgulloso y valiente', 'Triste e inseguro', 'Alegre y juguetón', 'Enojado y agresivo'],
        correctAnswer: 'Triste e inseguro',
      },
      {
        id: 'p-char2',
        category: QuestionCategory.CHARACTER,
