...
export const elPatitoFeo: Story = {
  ...
  coverImage: 'https://upload.wikimedia.org/wikipedia/commons/3/33/Duckling_03.jpg',
  content: `
...
-¡Qué grande es el mundo! -dieron todos los pequeños. Ciertamente ahora tenían más espacio para moverse que en el interior de sus cascarones.
...
-Hay un huevo que está tardando mucho tiempo -阻sposeó la pata que empollaba. Esa cáscara no se quiere romper. Pero, ¡mira los otros! Son los más preciosos patitos que he visto en mi vida. Tienen todos la mismísima cara de su padre, el gran pillo que ni siquiera se da una vuelta por aquí a verme.
...
And un pato corrió hacia el patito feo y le dio un picotazo en el cuello.
-¡Déjalo! -suplicó la madre-. No hace daño a nadie.
-Puede que no -阻splicó el que había atizado el picotazo-. Pero es tan desmañado y raro que dan ganas de darle una paliza.
...
And se sintieron todos cómodos, y en su casa, menos el pobre patito que había sido el último en salir del huevo, y que era tan feo. A éste lo picotearon y empujaron, y se burlaron de él patos y gallinas.
...
“¡Oh, gracias a Dios! -阻spiró el patito-. ¡Soy tan feo que ni siquiera el perro se molesta en morderme!”
...
El gato y la gallina eran algo así como dueños de aquella casa. Siempre decían: "Nosotros y el mundo” pues creían que ellos representaban la mitad del mundo; y por cierto que la mejor mitad. El patito pensaba que podían existir dos opiniones al respecto, pero el gato ni siquiera quería escucharlo.
...
-¡Vaya diversiones! -阻zongó la gallina-. Me parece que te has vuelto loco. Pregunta, si no, al gato qué opina; es el animal más inteligente que conozco. Pregúntale si le gusta flotar en el agua o zambullirse. Por mi parte no te digo nada. Pregúntale también a nuestra patrona, la vieja. No hay nadie en el mundo más lista que ella. ¿Y crees que tiene algún deseo de meterse en el agua?
...
-Lo que me parece es que me voy a marchar otra vez por el mundo -阻spondió el patito.
-Pues hazlo; será lo mejor -fue la terminante respuesta de la gallina.
And el patito se fue.
...
And no era que los envidiara en lo más mínimo, ¿cómo podía ocurrírsele envidiar aquella maravilla de belleza? Se habría sentido agradecido con sólo que los patos lo hubiesen tolerado entre ellos, tanta era la certeza de su fealdad.
...
De pronto el patito alzó las alas, y éstas se agitaron con mucha más fuerza que antes, haciéndolo ascender vigorosamente hacia el cielo. Antes que se diera cuenta de dónde estaba se encontró en un amplio jardín, rodeado de manzanos en flor respirando un aire perfumado por las lilas que crecian en las irregulares orillas del lago.

And vio también tres hermosos cisnes que se acercaban a él saliendo de entre un macizo de plantas. Nadaban suave y ágilmente, con un tenue rumor de plumas. El patito reconoció a las majestuosas aves y no pudo evitar que lo sobrecogiera una extraña melancolía.
...
¡Era un cisne! ¡Nada importaba haber nacido en un corral, si uno procedía de un huevo de cisne!
    ...
    [QuestionCategory.LITERAL]: [
      {
        ...
        questionText: '¿Cuál era el lugar exacto donde la madre pata estaba empollando sus huevos?',
        options: [
          'En un nido de paja dentro del granero viejo.',
          'Bajo unas hojas grandes junto al foso de agua.',
          'En el jardín secreto cerca del campo del cura.',
          'En la cocina cálida de la antigua mansión real.'
        ],
        correctAnswer: 'Bajo unas hojas grandes junto al foso de agua.',
      },
      {
        id: 'p-lit2',
        category: QuestionCategory.LITERAL,
        questionText: '¿Qué señal de distinción particular llevaba el pato viejo en su pata?',
        options: [
          'Un trozo de trapo rojo atado con firmeza.',
          'Una pequeña campana de plata brillante.',
          'Una pluma de cisne de un color dorado.',
          'Una cinta azul que le regaló la anciana.'
        ],
        correctAnswer: 'Un trozo de trapo rojo atado con firmeza.',
      },
      {
        id: 'p-lit3',
        category: QuestionCategory.LITERAL,
        questionText: '¿Qué animal del corral atacó primero al patito dándole un picotazo?',
        options: [
          'El gato Nene mientras comía su pescado.',
          'Un pato común por encontrarlo muy raro.',
          'La gallina Tachuela por no saber poner huevos.',
          'El pavo emperador al inflar sus plumas rojas.'
        ],
        correctAnswer: 'Un pato común por encontrarlo muy raro.',
      },
    ],
    [QuestionCategory.SEQUENCING]: [
      {
        ...
        questionText: '¿Qué acción realizó el patito inmediatamente después de nacer?',
        options: [
          'Se fue a nadar solo al pantano de los gansos.',
          'Se tambaleó y miró el gran mundo a su alrededor.',
          'Se peleó con sus hermanos por un pedazo de pan.',
          'Se escondió del gato en la mansión abandonada.'
        ],
        correctAnswer: 'Se tambaleó y miró el gran mundo a su alrededor.',
      },
      {
        id: 'p-seq2',
        category: QuestionCategory.SEQUENCING,
        questionText: 'Tras el ataque de los cazadores en el pantano, ¿qué decisión tomó el protagonista?',
        options: [
          'Regresó al corral a pedirle perdón a su madre.',
          'Huyó a toda prisa hasta llegar a una pequeña casa.',
          'Se quedó a vivir con los patos silvestres heridos.',
          'Buscó al perro de caza para hacerse su mejor amigo.'
        ],
        correctAnswer: 'Huyó a toda prisa hasta llegar a una pequeña casa.',
      },
      {
        id: 'p-seq3',
        category: QuestionCategory.SEQUENCING,
        questionText: '¿Qué le sucedió al pato durante la noche más helada del invierno?',
        options: [
          'Entró al granero y se durmió sobre el heno seco.',
          'Quedó atrapado en el hielo hasta que lo rescataron.',
          'Voló con los cisnes hacia un país mucho más cálido.',
          'Se ocultó bajo las alas de una cigüeña egipcia.'
        ],
        correctAnswer: 'Qued atrapado en el hielo hasta que lo rescataron.',
      },
    ],
    [QuestionCategory.VOCABULARY]: [
      {
        ...
        questionText: 'La cigüeña hablaba en "egipcio". ¿Qué nos indica esto en el cuento?',
        options: [
          'Que era un ave que venía de una tierra lejana.',
          'Que era un animal muy silencioso y misterioso.',
          'Que no quería que los patos la entendieran.',
          'Que era la dueña de la mansión abandonada.'
        ],
        correctAnswer: 'Que era un ave que venía de una tierra lejana.',
      },
      {
        id: 'p-voc2',
        category: QuestionCategory.VOCABULARY,
        questionText: 'El texto dice que la gallina "rezongó". ¿Qué hizo ella realmente?',
        options: [
          'Cantar una canción alegre para el gato Nene.',
          'Gruñir o quejarse en voz baja por un disgusto.',
          'Poner muchos huevos de una excelente calidad.',
          'Agradecer al pato por su gran ayuda en la cocina.'
        ],
        correctAnswer: 'Gruñir o quejarse en voz baja por un disgusto.',
      },
      {
        id: 'p-voc3',
        category: QuestionCategory.VOCABULARY,
        questionText: 'Al final, el protagonista recuerda sus "tribulaciones". ¿Qué son?',
        options: [
          'Los momentos de juego con los niños del campo.',
          'Las penas y sufrimientos que vivió en el pasado.',
          'Las plumas blancas que le crecieron en el invierno.',
          'Los consejos que le dio el pato viejo del trapo.'
        ],
        correctAnswer: 'Las penas y sufrimientos que vivió en el pasado.',
      },
    ],
    [QuestionCategory.MAIN_IDEA]: [
      {
        ...
        questionText: '¿Cuál es el mensaje central que nos deja la historia de Andersen?',
        options: [
          'Que los patos nadan mucho mejor que los pavos reales.',
          'Que la verdadera naturaleza de alguien surge al final.',
          'Que el invierno es la estación más linda para viajar.',
          'Que las gallinas y los gatos son dueños del mundo.'
        ],
        correctAnswer: 'Que la verdadera naturaleza de alguien surge al final.',
      },
      {
        id: 'p-main2',
        category: QuestionCategory.MAIN_IDEA,
        questionText: '¿Por qué el patito se siente feliz al final a pesar de haber sufrido tanto?',
        options: [
          'Porque por fin pudo comer cabezas de pescado ricas.',
          'Porque descubrió quién era y encontró un lugar propio.',
          'Porque logró asustar a los niños de la casa del granjero.',
          'Porque el Rey Dedede lo invitó a vivir en su castillo.'
        ],
        correctAnswer: 'Porque descubrió quién era y encontró un lugar propio.',
      },
      {
        id: 'p-main3',
        category: QuestionCategory.MAIN_IDEA,
        questionText: '¿Qué simboliza el cambio del patito gris en un cisne blanco?',
        options: [
          'El paso del tiempo y la madurez de un ser vivo.',
          'Un truco de magia que hizo la anciana de la casita.',
          'La llegada de la primavera al pantano de los juncos.',
          'El triunfo de la belleza física sobre la inteligencia.'
        ],
        correctAnswer: 'El paso del tiempo y la madurez de un ser vivo.',
      },
    ],
    [QuestionCategory.INFERENCE]: [
      {
        ...
        questionText: '¿Por qué el patito se sintió atraído por los cisnes al verlos volar?',
        options: [
          'Porque sus alas hacían un ruido muy fuerte al batir.',
          'Porque reconoció en ellos algo que le era familiar.',
          'Porque quería preguntarles cómo llegar a Egipto solo.',
          'Porque pensó que ellos tenían mucha comida para él.'
        ],
        correctAnswer: 'Porque reconoció en ellos algo que le era familiar.',
      },
      {
        id: 'p-inf2',
        category: QuestionCategory.INFERENCE,
        questionText: '¿Qué pensó el patito cuando el perro de caza se alejó sin morderlo?',
        options: [
          'Que el perro era muy cobarde y le tenía mucho miedo.',
          'Que su fealdad era tan grande que ni el perro lo quería.',
          'Que el cazador le había dado una orden secreta al can.',
          'Que el perro no tenía dientes para morder su cuello.'
        ],
        correctAnswer: 'Que su fealdad era tan grande que ni el perro lo quería.',
      },
      {
        id: 'p-inf3',
        category: QuestionCategory.INFERENCE,
        questionText: '¿Por qué la gallina y el gato no entendían los deseos del patito?',
        options: [
          'Porque eran animales muy tontos que no sabían hablar.',
          'Porque creían que su forma de vida era la única correcta.',
          'Porque estaban muy preocupados por poner huevos frescos.',
          'Porque el patito nunca les explicó lo que quería hacer.'
        ],
        correctAnswer: 'Porque creían que su forma de vida era la única correcta.',
      },
    ],
    [QuestionCategory.CHARACTER]: [
      {
        ...
        questionText: '¿Cómo se comporta el protagonista al ser admirado como el cisne más bello?',
        options: [
          'Con mucho orgullo y desprecio por los patos comunes.',
          'Con una gran humildad y alegría en su corazón puro.',
          'Con deseos de vengarse de la gallina y el gato Nene.',
          'Con mucha tristeza por extrañar su vida en el corral.'
        ],
        correctAnswer: 'Con una gran humildad y alegría en su corazón puro.',
      },
      {
        id: 'p-char2',
        category: QuestionCategory.CHARACTER,
        questionText: '¿Qué actitud tuvo la madre pata frente al maltrato de los otros?',
        options: [
          'Fue muy cruel y ella misma le dio los peores golpes.',
          'Trató de defenderlo un poco pero terminó rechazándolo.',
          'Luchó contra todo el corral para que él fuera el rey.',
          'Se fue de la mansión para buscar al padre de los patitos.'
        ],
        correctAnswer: 'Trató de defenderlo un poco pero terminó rechazándolo.',
      },
      {
        id: 'p-char3',
        category: QuestionCategory.CHARACTER,
        questionText: '¿Qué rasgo define mejor al pavo que se sentía un emperador?',
        options: [
          'Su gran sabiduría sobre las cosas reales del mundo.',
          'Su vanidad excesiva y su falta de respeto por los demás.',
          'Su valentía al defender al patito de los picotazos.',
          'Su habilidad para nadar en el foso de la antigua mansión.'
        ],
        correctAnswer: 'Su vanidad excesiva y su falta de respeto por los demás.',
      },
    ],
  },
};
