...
export const sukimuki: Story = {
  id: 'sukimuki',
  title: 'Historia de una Princesa, su Papá y el Príncipe Kinoto Fukasuka',
  author: 'María Elena Walsh',
  coverImage: 'https://4.bp.blogspot.com/-5awmL2GF4gc/WDQqzi1xsoI/AAAAAAAAELM/bnlUDY2unZ42qOzeciP6wJqcNQeEjW2MwCEw/s1600/carofarias41.jpg',
  content: `
...
Pero no pudo. ¿Por qué? Porque la Mariposa tuvo la ocurrencia de transformarse inmediatamente en un Príncipe. Un Príncipe buen mozo, simpático, inteligente, gordito, estudioso, valiente y con bigotito.
...
Pero el Príncipe no se iba a dejar echar así nomás. Peleó valientemente contra todos. Y los vigilantes se escaparon por una ventana. Y las tías se escondieron aterradas debajo de la alfombra. Y los cocineros se treparon a la lámpara.
