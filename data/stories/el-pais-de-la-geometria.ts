...
export const elPaisDeLaGeometria: Story = {
  id: 'el-pais-de-la-geometria',
  title: 'El País de la Geometría',
  author: 'María Elena Walsh',
  coverImage: 'https://3.bp.blogspot.com/-Alv_39rQjQU/WDQqBzI0WFI/AAAAAAAAELI/1GTv-MQoOPYK4ZcOjERx5IOnlowuQcRWACEw/s1600/240ac712216069.562652377247b.jpg',
  content: `
Había una vez un amplio país blanco de papel. El Rey de este país era el Compás. ¿Por qué no?

El Compás. Aquí viene caminando con sus dos patitas flacas: una pincha y la otra no. Jo jo jo jo jo, una pincha y la otra no.

El Rey Compás vivía en un gran palacio de cartulina en forma de icosaedro, con dieciocho ventanitas. Cualquiera de nosotros estaría contento en un palacio así, pero el Rey Compás no. Estaba siempre triste y preocupado. Porque para ser feliz y rey completo le faltaba encontrar a la famosa Flor Redonda. Jo jo jo jo jo, sin la Flor Redonda no.
...
–¡Harrrto! ¡Estoy harto de ángulos y rectas y puntos! ¡Sois todos unos cuadrados! (Este insulto ofendió mucho a los Trapecios).
-¡Estoy harto y amarrrgado! ¡Quiero encontrar a la famosa Flor Redonda!
...
En fin, ganaron los Triángulos por 1 a 0 (mérito singular si se tiene en cuenta que la pelota era un cubo). El Capitán de los Rombos fue a llorar su derrota en un rincón. El Comandante de los Triángulos, cansado y victorioso, se acercó al Rey:
...
Cuando volvieron, el Rey se encerró en su cuarto, espantosamente triste y amargado. Al rato entró la señora Línea a llevarle la sopita de tiza y se preocupó mucho al verlo tan triste.
