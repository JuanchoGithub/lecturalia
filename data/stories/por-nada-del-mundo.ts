...
export const porNadaDelMundo: Story = {
  id: 'por-nada-del-mundo',
  title: 'Por nada del mundo',
  author: 'Adela Basch',
  coverImage: `data:image/svg+xml;charset=utf-8,${encodeURIComponent('<svg width="600" height="400" viewBox="0 0 100 66.67" xmlns="http://www.w3.org/2000/svg"><rect width="100%" height="100%" fill="#3A86FF" /><g transform="rotate(85) translate(4)"><path d="M 0 0 L 50 0 L 50 50 L 0 50 Z" fill="#F7F9FB" opacity="0.5" transform="translate(0, 0)"/><path d="M 50 16 L 100 16 L 100 66 L 50 66 Z" fill="#FFBE0B" opacity="0.5" transform="translate(0, 0)"/></g></svg>')}`,
  content: `
