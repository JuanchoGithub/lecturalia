...
export const juanSinMiedo: Story = {
  id: 'juan-sin-miedo',
  title: 'Juan Sin Miedo',
  author: 'Hermanos Grimm',
  coverImage: 'https://picsum.photos/seed/juan-sin-miedo/600/400',
  content: `
...
El hombre quería echarlo, pero el mozo, empeñado en no ceder, lo apartó de un empujón e instaló en su asiento. Bajaron entonces por la chimenea nuevos hombres, uno tras otro, llevando nueve tibias y dos calaveras, y, después de colocarlas en la posición debida, comenzaron a jugar a bolos. Al muchacho le entraron ganas de participar en el juego y les preguntó:
