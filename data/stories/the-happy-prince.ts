...
export const theHappyPrince: Story = {
  ...
  author: 'Oscar Wilde',
  coverImage: 'https://upload.wikimedia.org/wikipedia/commons/4/4c/Plate_1_of_The_Happy_Prince_and_Other_Tales_%281888%29.png',
  content: `
...
-‘¡Qué fenómeno más notable!” -dijo el profesor de ornitología, al pasar por el puente- “¡Una golondrina en invierno!” Y escribió sobre este asunto una larga carta al periódico local. Todos la citaban y hablaban de ella, ¡estaba llena de tantas palabras que no alcanzaban a entender! ...

-“Esta noche parto para Egipto” -dijo la golondrina, sintiéndose entusiasmada con esta perspectiva. Visitó todos los monumentos públicos, y estuvo descansando largo rato en la cúspide del campanario. Donde quiera que fuese, los gorriones gorjeaban y se decían unos a otros: -“Que forastera tan distinguida”. Y se sentía muy contenta y halagada al oírlo.
